# Source: https://github.com/NixOS/nixpkgs/blob/nixos-unstable/pkgs/applications/misc/ArchiSteamFarm/default.nix
{
  lib,
  buildDotnetModule,
  fetchFromGitHub,
...
buildDotnetModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "ArchiSteamFarm";
    rev = version;
    hash = "sha256-vysuwKs9DiKupv/goUEOVEDxt7boQtJe+s2NfoqXiJk=";
  };
